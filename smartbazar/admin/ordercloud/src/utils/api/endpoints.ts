export const API_ENDPOINTS = {
  ...
  COUPONS: 'coupons',
  CUSTOMERS: 'customers',
  USERGROUPS: 'buyers/techgear/usergroups',
  // USERGROUPS: 'buyers/customer1/usergroups',
  // USERGROUPCUSTOMER: 'buyers/customer1/usergroups',
  // USERGROUPTECHGEAR:'buyers/techgear/usergroups',
  TAXES: 'taxes',
  SHIPPINGS: 'shippings',
  SETTINGS: 'settings',
